...
class InvertedResidualCell(nn.Module):
    ...
    def __init__(self, in_channels, num_heads=2, reduction=16):
        ...
        self.first_conv= PointwiseConv1d(in_channels, in_channels)
        ...
        self.final_conv = DepthwiseConv1d(in_channels, kernel_size=3, padding=1)
